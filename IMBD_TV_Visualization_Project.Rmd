...
**Note**: The duplicate() function keept the first instance of a record and removed the rest, which is why *His Dark Materials* rating of 9.7 was dropped. The first instance for this show had a rating of 7.8


## 2.3 String Extraction and Data Type Transformations of 'Release.Year', 'Runtime' and 'Rating'
...
# 2.5 Subset of Analysis: Top 100 Rated Shows

Due to the large amount of titles I have opted to focus on the top 100 shows based on ratings.
...
I have opted to keep the coerced NA's as many of the values were initially ommited. I will deal with them depending on the type of visualization. Furthermore I have ranked the top 100 series by rating, 'top100' will be our subset for analysis from here on.

# 3. Explanatory Data Analysis

## 3.1 Ordered Ratings Bar Plot
...
```{r echo=FALSE, fig.align='center', fig.pos="H", out.height="90%", out.width="90%"}
knitr::include_graphics("freq_tables.png")
```
...
## 4.1 Frequency of Most Popular Words in Sypnosis  
